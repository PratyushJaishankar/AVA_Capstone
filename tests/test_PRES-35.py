...
# Get all configured browsers for cross-browser testing
...
def test_add_address(driver, address_data, login_data):
    """
    Test to verify that a user can successfully add an address after logging in.
    Steps:
    ...
    7. Assert page title contains 'Market99' after login
    Expected Result: Address is successfully added and page title contains 'Market99'
    """
